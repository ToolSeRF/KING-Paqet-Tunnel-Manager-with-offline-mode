# اسکریپت KING (شاه)
اسکریپت شاه ، ابزار نصب آسان تانل paqet با امکان نصب افلاین و لینک داخلی پکت و ابزارهای مورد نیاز آن بر روی سرور ایران، ایجاد تانل paqet بین دو سرور با فقط با یک دستور،مدیریت تانل ها و سرویس ها، تغییر پیکربندی و پورت های تانل
...
لینک دانلود فایل های باینری و پیش نیازها
...
````
# 44 تانل آی دی است ، 8443 پورت تانل برای ارتباط بین دو سرور(لیستن)، 4 تعداد کانکشن ماکس است، fast حالت مود kcp است، 1300 مقدار MTU است، auto مقدار مک و اینترفیس را پیدا میکند، فایروال برای تنظیم فایروال است، start برای شروع سرویس، پس از آن key را دریافت و در سمت ایران به جای YOUR_KEY_HERE بزارید، ای پی خارج را با 10.10.20.10 جایگزین کنید،"8443=8443 80=8080" پورت هایی که فوروارد میشوند است با مقدار خودتان جایگزین کنید. 
# kharej side
