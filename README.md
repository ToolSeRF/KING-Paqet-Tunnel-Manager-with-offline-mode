# اسکریپت KING (شاه)
اسکریپت شاه ، ابزار نصب آسان تانل paqet با امکان نصب افلاین پکت و ابزارهای مورد نیاز بر روی سرور ایران، ایجاد تانل paqet بین دو سرور با فقط با یک دستور،مدیریت تانل ها و سرویس ها، تغییر پیکربندی و پورت های تانل
